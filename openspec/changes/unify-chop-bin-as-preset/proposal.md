...
Proposal only. Design, specs, and tasks are deferred until this is prioritized and branched for implementation
(on `feature/unify-chop-bin-as-preset`). This is a larger, architectural change; the `feature/toggle-side-cutouts`
branch was abandoned without merging, since the capability it added is superseded here.
