...
`(handle_width_mm + handle_gap_mm) / 2`.

#### Scenario: Handles alternate ends

- **WHEN** a block is generated for two or more knives
- **THEN** consecutive lanes place their handles at opposite ends, and the blades overlap through the block
